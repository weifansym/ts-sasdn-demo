...
class PostQuestionList extends sasdn_1.GatewayApiBase {
    constructor() {
        super();
        this.method = 'post';
    ...
    handle(ctx, next, params) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield questionLogic_1.questionLogic.questionList(ctx, next, params)
                .then((response) => {
...
exports.api = new PostQuestionList();
//# sourceMappingURL=postQuestionList.js.map